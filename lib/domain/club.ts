export type ClubSlug = "stc" | "otc" | "joogo" | "army" | "queensday" | "pt";
...
export const clubs: Club[] = [
  ...
  { slug: "pt", name: "Play Tennis", shortName: "Play Tennis", organizationLabel: "클럽", tournamentLabel: "클럽대회", seedSampleData: false }
];
